  ...
  return (
    <div className="my-10 flex flex-col text-justify">
      <div className="flex flex-row h-[500px]"> 
        ...
        {/* Texto */}
        <div className="flex-1 flex flex-col justify-center rounded-br-lg rounded-tr-lg bg-custom-yellow pr-7 pl-5 shadow-lg">
          ...
          <Link className="cursor-pointer" to={`/contact`}>
            <div className="flex flex-row text-gray-800 pt-4">
              <b className="text-sm">ENTRE EM CONTATO</b>
              <MdArrowRightAlt className="justify-center w-8 h-5" />
            </div>
          </Link>
        </div>
      </div>
